...
const AppointmentRequests = () => {
  ...
  const handleApprove = (requestId) => {
    ...
    toast.showSuccess(`Appointment approved for ${request.patientName}! Patient will be notified via email and SMS.`)
  ...
  const handleReject = (requestId, reason = '') => {
    ...
    toast.showWarning(`Appointment rejected for ${request.patientName}. Patient will be notified with the reason.`)
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                            ...
                            <div>
                              ...
                              <p className="font-medium text-[#111618] dark:text-white">{request.requestedDate}</p>
                              <p className="text-sm text-gray-600 dark:text-gray-400">{request.requestedTime}</p>
                            </div>
                            <div>
                              <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Contact</p>
                              <p className="font-medium text-[#111618] dark:text-white">{request.patientPhone}</p>
                              <p className="text-sm text-gray-600 dark:text-gray-400">{request.patientEmail}</p>
                            </div>
                            <div>
